package com.chuanwise.toolkit.preservable.loader;
...
public interface PreservableLoader<M> {
     ...
     */
    <T extends Preservable<M>> T load(Class<T> clazz, M medium) throws IOException;
     ...
     * @return
     */
    default <T extends Preservable<M>> T loadOrProduce(Serializer serializer, Class<T> clazz, M medium, Supplier<T> supplier) {
